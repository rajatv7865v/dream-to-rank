        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-2 animate-in slide-in-from-top duration-300">
            <Link
              ...
              className="block px-4 py-3 text-gray-700 font-medium rounded-lg hover:bg-gradient-to-r hover:from-emerald-50 hover:to-indigo-50 hover:text-emerald-600 transition-all duration-300"
            >
              Become a Mentor
            </Link>
            <Link
