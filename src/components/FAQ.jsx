...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: 'How can dreamtorank help me in my preparation?',
      answer: 'dreamtorank provides comprehensive UPSC preparation with AI-powered features including instant mains evaluation, unlimited MCQs and PYQs practice, 24x7 doubt resolution, complete syllabus coverage, current affairs updates, and detailed progress tracking.'
    },
    {
      question: 'Is dreamtorank free to use?',
      answer: 'dreamtorank offers a premium plan at ₹5,699 till Mains, which provides unlimited access to all features. This is significantly more affordable than coaching institutes (₹1L+ per year) or ChatGPT Pro (₹20K+ per year).'
    },
    {
    ...
    {
      question: 'How can I access dreamtorank? Is it available on all devices?',
      answer: 'dreamtorank is available as a web application and mobile app. You can access it on all devices including desktop, tablet, and mobile phones for seamless learning experience.'
    },
    {
    ...
    },
    {
      ...
      answer: 'dreamtorank is designed for all levels - beginners can start with our structured modules and PYQs, while working professionals can benefit from flexible learning schedules and quick evaluation features.'
    },
    {
      question: 'How do I get my academic doubts or account issues resolved?',
      answer: 'You can reach out to us via WhatsApp at +91 966053244, or email at info@dreamtorank.com. Our support team is available 24x7.'
    },
    {
      question: 'Does dreamtorank support vernacular languages like Hindi, Tamil, Telugu, etc.?',
      answer: 'Yes, dreamtorank supports multiple vernacular languages to make UPSC preparation accessible to students from all regions of India.'
    }
  ];
